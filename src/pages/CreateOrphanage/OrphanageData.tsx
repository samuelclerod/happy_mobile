...
export default function OrphanageData() {
    ...
    const handleCreateOrphanage = async () => {
        ...
        data.append('about', about as any)
        data.append('instructions', instructions as any)
        data.append('opening_hours', opening_hours as any)
        data.append('whatsapp', whatsapp as any)
        data.append('open_on_weekends', open_on_weekends as any)
        images.forEach((image, index) => data.append('images', {
            name: `image_${image}-${index}.jpg`,
            type: 'image/jpg',
            uri: image
        } as any
        ))
